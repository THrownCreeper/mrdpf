...
\begin{enumerate}
	...
	\item \path{{base}/Data/Library/Preferences/com.microsoft.rc.macos.plist}
\end{enumerate}
...
Rerefence section III-B1. The file \path{{source2}/offlinestorageHigh.dat} contains a ISO 8601 formatted date that represents the first time the application was launched.
...
Reference section III-B2. The \path{{source2}/FirstStartTime.dat} file contains telemetry logs that may provide insight into the date/time the application was in use.
